                        ...
                        return (
                            <div className="form-item" key={sku.sku_name+index}>
                                ...
                                <div className="inline-block ant-form-item-label">
                                    ...
                                    <img src={sku.sku_image} className="product-modal-avatar-small" alt="avatar" />
                                </div>
                                <div className="inline-block ant-form-item-label">
                                ...
                                <Form.Item className="inline-block" validateTrigger={'onBlur'} form={form} name="sku[index].price" label="价格">
                                    <InputNumber min={0} className="input-small input-handler" formatter={numberFormatter} />
                                </Form.Item>
                                <Form.Item className="inline-block" validateTrigger={'onBlur'} form={form} name="sku[index].freight" label="运费">
                                    <InputNumber min={0} className="input-small input-handler" formatter={numberFormatter} />
                                </Form.Item>
                                <Form.Item className="inline-block" validateTrigger={'onBlur'} form={form} name="sku[index].storage" label="库存">
                                    <InputNumber min={0} className="input-small input-handler" formatter={numberFormatter} />
                                </Form.Item>
                            </div>
                        )
