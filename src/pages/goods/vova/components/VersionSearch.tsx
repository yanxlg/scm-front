            ...
            <React.Fragment>
                <Form layout="inline" autoComplete={'off'}>
                    <div className="inline-block">
                        <Form.Item className="margin-none" form={form} name="onshelf_time_satrt" label="时间">
                            <DatePicker
                                disabledDate={(currentDate) => currentDate ? onshelf_time_end ? currentDate.isAfter(onshelf_time_end) : false : false}
                        ...
                        <Form.Item form={form} name="onshelf_time_end">
                            <DatePicker
                                disabledDate={(currentDate) => currentDate ? onshelf_time_satrt ? currentDate.isBefore(onshelf_time_satrt) : false : false}
                                className="picker-small"/>
                        </Form.Item>
                    </div>
                    ...
                    <Button loading={searchLoading} onClick={this.onSearch} type="primary"
                            className="btn-group">查询</Button>
                    <Button loading={exportLoading} onClick={this.onExport} type="primary"
                            className="btn-group">导出Excel</Button>
                    <Button loading={activeLoading} onClick={this.onActive} type="primary"
                            className="btn-group">应用新版本</Button>
                </Form>
            </React.Fragment>
        );
    }
