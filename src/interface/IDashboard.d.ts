...
export interface IOverviewInfo {
    ...
    actualGrossProfitRatio: string;           // 实际毛利环比
    expectedGrossProfit: string;              // 预期毛利
    expectedGrossProfitRatio: string;         // 预期毛利环比
    storageBacklogCost: string;               // 仓储积压成本
    storageBacklogCostRatio: string;          // 仓储积压成本环比
    actualPurchaseCost: string;               // 实际采购成本
    actualPurchaseCostRatio: string;          // 实际采购成本环比
    saledGoodsNum: string;                    // 有销量商品数量
    saledGoodsNumRatio: string;               // 有销量商品数量环比
    onsaleGoodsNum: string;                   // 在架商品数量
    onsaleGoodsNumRatio: string;              // 在架商品数量环比
    pinRate: string                           // 动销率                   
    pinRateRatio: string;                     // 动销率环比
}
